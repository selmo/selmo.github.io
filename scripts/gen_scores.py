...
CORRECTIONS = {
    ...
    "화답송 - 주님저희에게자비를.pdf": dict(title="주님 저희에게 자비를", composer="최태형", mass_part="responsorial_psalm"),
    "주님저희에게자비를.pdf": dict(title="주님 저희에게 자비를", composer="최태형", mass_part="responsorial_psalm"),
